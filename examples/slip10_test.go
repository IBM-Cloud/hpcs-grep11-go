...
// Example_slip10_DeriveKey derives sets of privte/public key pairs using SLIP10
...
func slip10DeriveKey(cryptoClient pb.CryptoClient, deriveType pb.BTCDeriveParm_BTCDeriveType, oid asn1.ObjectIdentifier, childKeyIndex uint64, baseKey *pb.KeyBlob, chainCode []byte) (*pb.KeyBlob, []byte) {
...
func slip10SignAndVerify(cryptoClient pb.CryptoClient, oid asn1.ObjectIdentifier, privateKey *pb.KeyBlob, publicKey *pb.KeyBlob) bool {
...
func slip10DeriveKeySlip10SignAndVerifySingle(cryptoClient pb.CryptoClient, oid asn1.ObjectIdentifier, privateKey *pb.KeyBlob, publicKey *pb.KeyBlob) bool {
	mech, err := util.GetSignMechanismFromOID(oid)
	if err != nil {
		panic(fmt.Errorf("Unexpected OID: %+v", oid))
	}
...
func Example_slip10CrossSignAndVerify() {
	...
	// Keys of NIST P-256
	var publicKeyP256, privateKeyP256 *pb.KeyBlob
	...
	// Keys of Secp256k1
	var privateKey256k1, publicKey256k1 *pb.KeyBlob
	...
	// Keys of ED25519
	var privateKeyEd25519, publicKeyEd25519 *pb.KeyBlob
...
func slip10SignSingleAndVerify(cryptoClient pb.CryptoClient, oid asn1.ObjectIdentifier, privateKey *pb.KeyBlob, publicKey *pb.KeyBlob) bool {
	mech, err := util.GetSignMechanismFromOID(oid)
	if err != nil {
		panic(fmt.Errorf("Unexpected OID: %+v", oid))
	}
...
func slip10SignAndVerifySingle(cryptoClient pb.CryptoClient, oid asn1.ObjectIdentifier, privateKey *pb.KeyBlob, publicKey *pb.KeyBlob) bool {
	mech, err := util.GetSignMechanismFromOID(oid)
	if err != nil {
		panic(fmt.Errorf("Unexpected OID: %+v", oid))
	}
